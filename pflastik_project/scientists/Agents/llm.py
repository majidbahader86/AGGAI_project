# The script's main purpose is to handle and streamline the usage of these models, especially regarding logging token usage, handling retries with exponential backoff, and managing API responses
import logging
import os
import random
import threading
